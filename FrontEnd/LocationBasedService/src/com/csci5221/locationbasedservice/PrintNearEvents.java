...
public class PrintNearEvents extends ListActivity {
	String user;
	List<Event> eventList = null;
	static List<Event> eventListStatic = null;
	public static final String URL = "http://"+IContants.IPADDRESS+":8080/LocationServices/HomeServlet?request=GetEvent&";
